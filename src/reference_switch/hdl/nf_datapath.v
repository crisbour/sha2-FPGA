...
module nf_datapath #(
    ...
    wire [C_M_AXIS_DATA_WIDTH - 1:0]         m_axis_ns2_tdata;
    wire [((C_M_AXIS_DATA_WIDTH / 8)) - 1:0] m_axis_ns2_tkeep;
    wire [C_M_AXIS_TUSER_WIDTH-1:0]          m_axis_ns2_tuser;
    wire                                     m_axis_ns2_tvalid;
    wire                                     m_axis_ns2_tready;
    wire                                     m_axis_ns2_tlast;
  //Input Arbiter
  input_arbiter_ip  input_arbiter_v1_0 (
      ...
      //.s_axis_3_tdata (512'd0), 
      //.s_axis_3_tkeep (64'd0), 
      //.s_axis_3_tuser (128'd0), 
      //.s_axis_3_tvalid(1'b0), 
      //.s_axis_3_tready(), 
      //.s_axis_3_tlast (1'b0), 
      //.s_axis_4_tdata (s_axis_2_tdata), 
      //.s_axis_4_tkeep (s_axis_2_tkeep), 
      //.s_axis_4_tuser (s_axis_2_tuser), 
      //.s_axis_4_tvalid(s_axis_2_tvalid), 
      //.s_axis_4_tready(s_axis_2_tready), 
      //.s_axis_4_tlast (s_axis_2_tlast), 
    ...
    nf_sha2_engine sha2_hash_engine(
        ...
        // Output
        .m_axis_tdata (m_axis_ns2_tdata), 
        .m_axis_tkeep (m_axis_ns2_tkeep), 
      ...
      .axis_aclk(axis_aclk), 
      .axis_resetn(axis_resetn), 
      .s_axis_tdata   (m_axis_ns2_tdata), 
      .s_axis_tkeep   (m_axis_ns2_tkeep), 
      .s_axis_tuser   (m_axis_ns2_tuser), 
      .s_axis_tvalid  (m_axis_ns2_tvalid), 
      .s_axis_tready  (m_axis_ns2_tready), 
      .s_axis_tlast   (m_axis_ns2_tlast), 
      ...
      //.m_axis_3_tlast (), 
      //.m_axis_4_tdata (m_axis_2_tdata), 
      //.m_axis_4_tkeep (m_axis_2_tkeep), 
      //.m_axis_4_tuser (m_axis_2_tuser), 
      //.m_axis_4_tvalid(m_axis_2_tvalid), 
      //.m_axis_4_tready(m_axis_2_tready), 
      //.m_axis_4_tlast (m_axis_2_tlast), 
      .bytes_stored(), 
      .pkt_stored(), 
      .bytes_removed_0(), 
      .bytes_removed_1(), 
